...
ephe_path = os.path.join(script_dir, 'ephe')  # Files will be in a subfolder called 'ephe'
...
def main():
 ...
 # Ask about Solar Return
    ...
    # ADD SOLAR RETURN
    if do_solar_return == 'y' and do_natal == 'y':
    ...
    # ADD PROGRESSIONS
    if do_progressions == 'y' and do_natal == 'y':
    ...
    if do_relocation == 'y' and relocation_data and do_natal == 'y':
