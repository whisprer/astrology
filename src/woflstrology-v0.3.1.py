...
def calculate_asteroid(asteroid_number, year, month, day, hour, minute, second, timezone_str="UTC"):
    ...
    try:
        ...
        # Try with Swiss Ephemeris files first, fall back to astorb.dat
        try:
        ...
        print(f"⚠ Asteroid #{asteroid_number} calculation failed: {e}")
        return None
...
def main():
    ...
    name_search_list = []  # Initialize the list!
    ...
    print(f"\n✓ Collected {len(name_search_list)} names to search\n")
    ...
    if name_search_list:
        ...
        print("======================================================================\n")
        for search_name in name_search_list:
            ...
            if matches:
                ...
                for match in matches:
                    ...
                    # Calculate position for this asteroid
                    pos = calculate_asteroid(
                        match['number'], 
                    ...
                    if pos:
                        ...
                        retro = " ℞" if pos["retrograde"] else ""
                        print(f"    {pos['sign']} {pos['degrees_in_sign']:.1f}°{retro} (House {house})\n")
            else:
        ...
        # print(f"{'=' * 70}\n") 
        # print("\n======================================================================\n")
        # print("🔍 DEBUG: Checking name search and thematic scan data...")
        # print(f"Name search list: {name_search_list}")
        # print(f"Selected themes: {selected_themes}")
        # print(f"Length of name_search_list: {len(name_search_list)}")
        # print(f"Length of selected_themes: {len(selected_themes)}")
        # print("\n")
        # # NAME SEARCH RESULTS
        # if name_search_list:
        #     print(f"\n🔍 Processing {len(name_search_list)} name searches...")
        #     for search_name in name_search_list:
        #         print(f"\n  Searching for: {search_name}")
        #         # Rest of name search code...
        # else:
        #     print("✗ No names to search for")


    # THEMATIC SCAN RESULTS  
    if selected_themes:
        print(f"\n🔮 Processing {len(selected_themes)} themes...")
        # Rest of thematic scan code...
    else:
        print("✗ No themes selected")
