...
def calculate_asteroid(asteroid_number, year, month, day, hour, minute, second, timezone_str="UTC"):
    ...
    try:
        ...
        # Use flag 0 to access astorb.dat (no Swiss Ephemeris files needed)
        ...
        # Only print error if it's something OTHER than "not found in astorb.dat"
        error_msg = str(e).lower()
        if "not found" not in error_msg and "astorb" not in error_msg:
